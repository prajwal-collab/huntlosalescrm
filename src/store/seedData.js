...
export const SEED_MEETINGS = [
  ...
  },
  {
    ...
    notes: 'Negotiated ARR from $350k to $320k for multi-year contract.',
    ai_summary: 'Stripe requested a price reduction in exchange for a 3-year term. Agreed to $320k ARR. Agreed SLA to be finalized.',
    next_action: 'Send contract draft with $320k ARR',
